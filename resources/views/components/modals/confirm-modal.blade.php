...
<div x-data="{ show: false, itemId: null }" x-show="show" x-on:confirm.window="itemId = $event.detail; show = true"
        ...
        <div x-show="show" x-transition:enter="ease-out duration-300"
            ...
            <div class="p-6 space-y-6">
                <form method="POST" x-bind:action="'{{ $route }}'">
                    @csrf
                    <input type="hidden" name="letter_id" x-bind:value="itemId">
            ...
            <div
                ...
                <button type="submit"
                    class="text-white {{ $type === 'confirm' ? 'bg-green-600 hover:bg-green-700 focus:ring-green-300' : 'bg-blue-600 hover:bg-blue-700 focus:ring-blue-300' }} focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:{{ $type === 'confirm' ? 'bg-green-600 hover:bg-green-700' : 'bg-blue-600 hover:bg-blue-700' }}">
                    {{ $confirmText }}
                </button>
            </div>
            </form>
