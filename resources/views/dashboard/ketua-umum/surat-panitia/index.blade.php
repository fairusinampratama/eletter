...
<x-dashboard.page-wrapper :title="$title" :breadcrumbItems="[['label' => 'Surat Panitia']]" :showFilter="true"
    :filterRoute="'ketua-umum.surat-panitia.index'" :filterPlaceholder="'Cari surat panitia...'" :showAddButton="false">
    <livewire:table :model="App\Models\Letter::class" :routePrefix="'ketua-umum.surat-panitia'" :columns="[
