...
<x-dashboard.page-wrapper :title="$title" :breadcrumbItems="[['label' => 'Surat Panitia']]" :showFilter="true"
    :filterRoute="'pembina.surat-panitia.index'" :filterPlaceholder="'Cari surat panitia...'" :showAddButton="false">
    <livewire:table :model="App\Models\Letter::class" :routePrefix="'pembina.surat-panitia'" :columns="[
        ...
        :defaultSort="['field' => 'date', 'direction' => 'desc']" :scopes="['committeeOnly', 'hasMentorSignature']" />
